...
app.layout = html.Div([
                          ...
                          dbc.Row([
                              ...
                              dbc.Col([
                                  ...
                                  dcc.Store(id='project_dir', data=os.getcwd()),
                                  ...
                                  dbc.Col([
                                      ...
                                      html.Button('git clone', id='git_clone', n_clicks=0,
                                                  style={"margin-left": "15px"}),
                                      dbc.Modal(
                                          id='modal_clone',
                                          size='lg',
...
def list_cwd_files(cwd, clk_d2, clk_d4, clk_d5, clk_d6, clk_d7, clk_d8, clk_d9, clk_d10, clk_d11, clk_d12, clk_d13):
    path = Path(cwd)
    all_file_details = []
    if path.is_dir():
...
def write_mem_user(project_dir, id_val, token_val):
    file_path = project_dir + "/mem_user.txt"
    with open(file_path, "w+") as file:
        file.seek(0)
        file.write("1\n")
        file.write(id_val + "\n")
        file.write(token_val + "\n")
        file.truncate()
